            ...
            <li>
              <div className="flex flex-col gap-y-6 sm:gap-y-8">
                <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                  ...
                  <blockquote className="relative">
                    <p className="text-lg tracking-tight text-slate-900">An amazing experience, from the site design to the checkout process. I was able to easily find what I needed and receive my products on time!</p>
                  </blockquote>
                  <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                    <div>
                      <div className="font-display text-base text-slate-900">Alex Wilks</div>
                    </div>
                    <div className="overflow-hidden rounded-full bg-slate-50">
                      <img alt="" className="h-14 w-14 object-cover" src="https://randomuser.me/api/portraits/men/18.jpg" />
                    </div>
                  </figcaption>
                </figure>
              </div>
            ...
            <li>
              <div className="flex flex-col gap-y-6 sm:gap-y-8">
                <figure className="relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10">
                  ...
                  <blockquote className="relative">
                    <p className="text-lg tracking-tight text-slate-900">I was initially hesitant about buying online, but the customer support was amazing, and the items exceeded my expectations!</p>
                  </blockquote>
                  <figcaption className="relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6">
                    <div>
                      <div className="font-display text-base text-slate-900">Jacob Miller</div>
                    </div>
                    <div className="overflow-hidden rounded-full bg-slate-50">
